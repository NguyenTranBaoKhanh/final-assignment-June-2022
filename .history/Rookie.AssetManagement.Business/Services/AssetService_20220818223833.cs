...
namespace Rookie.AssetManagement.Business.Services
{
    public class AssetService : IAssetService
    {
        ...
        public async Task<PagedResult<AssetDto>> GetPaginationAsync(AssetRequestDto request)
        {
            ...
            // var ass =  _context.Assets.Where(a => !a.IsDeleted).Include(a=>a.Location).Include(a => a.Category).AsQueryable();
            // var result = ass.Where(ass => ass.Location.LocationID == request.LocationId);
